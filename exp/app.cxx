...
auto main(int argc, char** argv) -> int
{
    ...
    std::println("{}", *(std::string const*)pfn((void*)"A"));
    std::println("{}", *(std::string const*)pfn((void*)"B"));
    (*str) = "C";
    std::println("{}", *(std::string const*)pfn((void*)"D"));
    std::println("{}", *(std::string const*)pfn((void*)"E"));
